...
import com.agile.engine.challenge.repository.rest.images.GetImagesRestRepository
import com.agile.engine.challenge.repository.rest.auth.ObtainAuthTokenRestRepository
import com.agile.engine.challenge.repository.rest.images.GetImageDetailRestRepository
...
class MainModule(private val vertx: Vertx, private val config: JsonObject) : AbstractModule() {
    ...
    override fun configure() {
        ...
        bind(GetImageDetailRepository::class.java).to(GetImageDetailRestRepository::class.java)
